              ...
              <Link key={cat} href="/product-listing">
                <Button
                  ...
                  className={`rounded-full px-4 text-xs md:px-5 md:text-sm ${
                    activeCategory === cat
                      ? "bg-highlight text-primary hover:bg-primary"
                      : "border bg-transparent text-primary hover:bg-highlight hover:text-accent"
                  }`}
                >
                  {cat}
                </Button>
            ...
            <Link key={p.id} href={href} className="group">
              ...
              <CardContent className="flex flex-col p-4">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <Button
                    size="icon"
                    className="h-8 w-8 rounded-full bg-neutral transition-colors hover:bg-highlight md:h-9 md:w-9"
                  >
                    <ArrowUpRight className="h-3 w-3 text-primary md:h-4 md:w-4" />
                  </Button>
                </div>
              </CardContent>
            </Card>
      ...
      {filtered.length > 0 && (
        <div className="mt-10 flex justify-center">
          <Link href="/product-listing">
            <Button
              variant="outline"
              className="flex items-center gap-2 rounded-[12px] border border-neutral px-6 py-3 text-sm font-medium transition-colors bg-highlight hover:bg-primary hover:text-accent text-primary md:text-base"
            >
              View All

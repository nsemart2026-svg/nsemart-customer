      ...
      <div className="max-w-6xl mx-auto">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex flex-col gap-2">
                  {settings?.contactAndSocial?.facebookUrl?.map(
                    (url, index) => {
                      const labels = ["NS eMart", "NS eMart ", "NS eMart"];
                      return (
                        <a
                          key={index}
                          href={url}
              ...
              <li>
                <a
                  href={(() => {
                    ...
                    const phone =
                      settings?.contactAndSocial?.phone || "+8801714302080";
        ...
        <div className="mt-12  pt-8 border-t border-gray-200 text-center">
          <p className="text-sm text-gray-500 mb-4 ">
            © {new Date().getFullYear()} NS eMart. All rights reserved - Design
            &amp; Developed by <span className="text-md">WebQ Team</span>
          </p>
        </div>
      </div>
    </footer>
